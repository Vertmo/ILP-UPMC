...
import antlr4.ILPMLgrammar2tme5Parser.NamedBreakContext;
import antlr4.ILPMLgrammar2tme5Parser.NamedContinueContext;
import antlr4.ILPMLgrammar2tme5Parser.NamedLoopContext;
...
public class ILPMLListener implements ILPMLgrammar2tme5Listener {
    ...
    @Override
    public void exitNamedLoop(NamedLoopContext ctx) {
        ctx.node = factory.newNamedLoop(ctx.condition.node, ctx.body.node, ctx.name.getText());
    }

    @Override
    public void exitNamedBreak(NamedBreakContext ctx) {
        ctx.node = factory.newNamedBreak(ctx.name.getText());
    }

    @Override
    public void exitNamedContinue(NamedContinueContext ctx) {
        ctx.node = factory.newNamedContinue(ctx.name.getText());
    }

    @Override public void enterNamedLoop(NamedLoopContext ctx) {}
    @Override public void enterNamedBreak(NamedBreakContext ctx) {}
    @Override public void enterNamedContinue(NamedContinueContext ctx) {}
}
