package com.paracamplus.ilp2.ilp2tme4.parser;
...
import com.paracamplus.ilp2.ilp2tme4.UnlessRemover;
...
public class ILPMLParser extends com.paracamplus.ilp2.parser.ilpml.ILPMLParser {
    ...
    public IASTprogram getProgram() throws ParseException {
      ...
      // Methode 2
      // return new ASTfactory().newProgram(tree.node.getFunctionDefinitions(), tree.node.getBody().accept(new UnlessRemover(), null));
