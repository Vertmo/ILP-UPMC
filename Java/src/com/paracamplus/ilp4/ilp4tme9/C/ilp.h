...
extern ILP_general_function ILP_find_method (ILP_Object receiver,
                                             ILP_Method method,
                                             int argc);
extern ILP_general_function ILP_find_method_global_cache(ILP_Object receiver, ILP_Method method, int argc);
extern ILP_general_function ILP_find_method_method_cache (ILP_Object receiver, ILP_Method method, int argc);
