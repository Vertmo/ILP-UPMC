...
typedef struct _ILP_Dyna_Fields {
  char *fieldname;
  struct ILP_Object *value;
  struct _ILP_Dyna_Fields *next;
} *ILP_Dyna_Fields;
...
/* Added property stuff */
#define ILP_AllocateDynaField() malloc(sizeof(ILP_Dyna_Fields));
extern ILP_Object ILP_read_property(ILP_Object instance, ILP_Object field);
extern ILP_Object ILP_write_property(ILP_Object instance, ILP_Object field, ILP_Object value);
extern ILP_Object ILP_has_property(ILP_Object instance, ILP_Object field);
