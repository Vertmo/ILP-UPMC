...
public class ILPMLListener implements ILPMLgrammar4tme8Listener {
    ...
    @Override public void enterReadExprField(ReadExprFieldContext ctx) {}

    @Override
    public void exitReadExprField(ReadExprFieldContext ctx) {
        ctx.node = factory.newReadProperty(ctx.fie.node, ctx.obj.node);
    }

    @Override public void enterHasField(HasFieldContext ctx) {}

    @Override
    public void exitHasField(HasFieldContext ctx) {
        ctx.node = factory.newHasProperty(ctx.fie.node, ctx.obj.node);
    }

    @Override public void enterWriteExprField(WriteExprFieldContext ctx) {}

    @Override
    public void exitWriteExprField(WriteExprFieldContext ctx) {
        ctx.node = factory.newWriteProperty(ctx.fie.node, ctx.obj.node, ctx.val.node);
    }
