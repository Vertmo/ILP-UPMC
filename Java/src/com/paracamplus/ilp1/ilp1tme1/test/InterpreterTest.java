...
public class InterpreterTest {
    ...
    public void testGetAllButLastInstructions() {
        ASTfloat f = new ASTfloat("4.0");
        IASTexpression[] exprs1 = { f, new ASTstring("Coucou") };
        IASTexpression[] exprs2 = { f };
        IASTSequence s1 = new ASTSequence(exprs1);
        try {
            Assert.assertArrayEquals(exprs2, s1.getAllButLastInstructions());
        } catch (Exception e) {
            Assert.fail();
        }
    }
